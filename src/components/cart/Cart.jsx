...
export const Cart = () => {
    ...
    newCart.totalPrice = cart?.reduce((acc, current) => acc + Number(current?.specialPrice) * Number(current?.quantity), 0);
    ...
    return (
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div>
                {cart && cart.length > 0 &&
                    cart.map((product, index) => <ItemContent key={index} {...product}/>)}
            </div>
            <div
